...
class PhysicsEngine:
    ...
    def __init__(self, controller):
        ...
        self.drive_counts_per_rev = SwerveModule.DRIVE_COUNTS_PER_REV
        self.drive_counts_per_meter = SwerveModule.DRIVE_COUNTS_PER_METRE
    ...
    def update_sim(self, hal_data, now, tm_diff):
        ...
        for i, can_id in enumerate(self.module_drive_can_ids):
            ...
            if talon["control_mode"] == ctre.ControlMode.Velocity:
                ...
                enc_speed = 0
            speed = enc_speed / SwerveModule.DRIVE_COUNTS_PER_100MS_TO_METRES_PER_SECOND
...
def the_cool_drive(module_speeds, module_angles, tm_diff):
    ...
    for module_speed, module_angle in zip(module_speeds, module_angles):
        module_displacement = module_speed * tm_diff
        vx.append(math.cos(module_angle) * module_displacement)
        vy.append(math.sin(module_angle) * module_displacement)
