    ...
    for idx in range(len(waypoints)-1):
        ...
        if v > u:
            ...
            if s > segment_distance:
                ...
                continue
            intermediate = (dx*s/segment_distance + segment_start[0],
                    dy*s/segment_distance + segment_start[1]) + segment_end[2:]
            ...
            if s < 0:
                ...
                continue
            intermediate = (dx*s/segment_distance + segment_start[0],
                    dy*s/segment_distance + segment_start[1]) + segment_start[2:]
